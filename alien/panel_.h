...
code PanelType Panel7 =
{
	...
	1688,       // Display Horizontal Total Clock Number in One Display Line

	1688,       // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1688,//1352,       // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	16,         // Display Vertical Start Position
	1024,       // Display Vertical Height

	1066,       // Display Vertical Total Line Number in One Frame

	16,         // Display H Sync Width
	3,          // Display V Sync Height

	108,//95,         // Typical Pixel Clock in MHz
